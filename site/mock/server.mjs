...
const SETTING_SPECS = [
  ...
  ["golive_autolink_youtube_video", "bool", false, false, "true lets a go-live whose Discord status carries a YouTube video link find the video's channel and link the person to it; false leaves such a link unread. Off by default: it reads YouTube's page, which can change, and a video is not always the streamer's own"],
