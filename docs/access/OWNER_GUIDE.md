...
> Last verified: **2026-09-03** for the sweeps count (**134** rows, numbered to 134 — 126–134 are the PINGS
...
| Test something | [`sweeps.md`](sweeps.md) — 134 rows in priority order, each with what to expect (+ the detailed phase 1–8a scripts) |
