...
>
> | What | v118 (`main`, 2026-09-17) | Where it is measured |
> |---|---|---|
...
> | Schema version | **40** (v118, polls shadow: `polls.shadow_message_id`; 39 at v116) | `storage/db.py:SCHEMA_VERSION` |
> | Registry keys | **232** (was 230 at v117) — **25 namespaces, the `/settings` select's cap** | `settings_store.KEY_TYPES` |
...
> | Tests | **6086** | the v118 deploy gate |
> | Deploys | **115**, last `3fe05ef` (v118) at 2026-09-17 10:11 | `../deploys.log` |
>
