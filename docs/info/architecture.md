...
> | Schema version | **49** (v149, `post_versions`; 48 at v148 the `spotlight_*` tables, 47 at v146) | `storage/db.py:SCHEMA_VERSION` |
> | Registry keys | **293** on `main` at v149 (two `posts_versions_*` + `golive_boot_sweep`; 290 at v148) — **25 namespaces** | `len(settings_store.KEY_TYPES)` |
