...
> DISCORD.** Before that, **2026-09-20** — row **`CM-c`** added at the foot for the POSTS EDITOR'S TWO-COLUMN MODAL (branch
...
> **2026-09-20** — rows **`PP-a` … `PP-f`** added at the foot for THE POSTS PAGE REBUILD (stage 3, branch
...
## The Discord mock — `DM-a` … `DM-d` (branch `discord-mock`, 2026-09-20)
...
## THE DRAWER BECOMES A CENTRED MODAL (rows `CM-a` … `CM-d`; branch `centre-modal`, off `main` `e177b27`, design [`../info/ux-audit-design.md`](../info/ux-audit-design.md) ▸ Deviations, 2026-09-20. `CM-c` added by branch `posts-two-col`, off `main` `65e225b`, same day. `CM-d` added by branch `modal-sweep`, off `main` `941ee26`, same day.)
