...
const PAGES = [
  ...
  { slug: 'requests', title: 'Requests', rank: 10, severity: 'warn', fails: 2, from: 9, to: 2, live: true,
    what: 'Rebuilt and live: one list of requests with status chips and counts, and one section of machinery, instead of seven stacked card lists. A row opens the request in a modal with its card, the legal moves and the staff thread.' },
