...
- **Wave-1 review findings — what is still open after ENGINEERING SWEEP 3 (v93, 2026-09-05; the
  ...
  saved drafts become real, one per person per guild enforced by the schema, design in
  [`info/poll-drafts-design.md`](info/poll-drafts-design.md), **BUILD DISPATCHED 10:10** (Opus, branch
  `poll-drafts`, worktree `C:/lcw/bb-poll-drafts`, schema 32 → 33, est 250–400k); there is no
