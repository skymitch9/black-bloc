...
// The 47 keys the three namespaces held on 2026-09-20, measured with
...

{
  ...
  is(`${where} — the namespaces held 47 keys when this was measured`, NAMESPACE_KEYS.length, 47);
...
process.stdout.write(
  'golive-join: ok - one row per person across five payloads; a ping role with no link still '
    ...
    + 'that IS a linked login is not a second; all 47 settings keys land in exactly one place\n',
);
