...
> Last verified: **2026-09-05** for the sweeps count (**187** rows, numbered to 187, plus the MOD
> CASES PANEL build's `C1`–`C11`, lettered on its branch and awaiting numbering at the merge —
> 183–187 are the
...
| Test something | [`sweeps.md`](sweeps.md) — 187 rows in priority order, each with what to expect (+ the detailed phase 1–8a scripts) |
