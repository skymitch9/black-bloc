...
> Last verified: **2026-09-25 22:3x** — the HEADER and the new v171 entry only, at the v171 docs ritual. The newest entry is **2026-09-25 (v171, one merge: marathon-notice-when)**, ONE TODO item moved whole into it; the last line of [`deploys.log`](deploys.log) is v171 (170 lines), which matches. ⚠️ **NOT checked:** any older entry's facts (the v167–v170 entries were written at their own rituals); nothing in the ritual met Discord by hand or a browser.
