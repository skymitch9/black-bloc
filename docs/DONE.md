...
> Last verified: **2026-09-25 14:2x** — the HEADER and the new v164 entry only, at the v164 docs ritual. The newest entry is **2026-09-25 (v164, four merges: spotlight-ping-windows, marathon-schedule, marathon-next-event, marathon-events-page, plus the Channels row off the nav)**, seven TODO items moved whole into it; the last line of [`deploys.log`](deploys.log) is v164 (163 lines), which matches. ⚠️ **NOT checked:** any older entry's facts; nothing in the ritual met Discord by hand or a browser. The *newest entry* sentence in the 18:3x paragraph below is history.
