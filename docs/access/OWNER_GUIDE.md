...
> Last verified: **2026-09-03** for the sweeps count (**125** rows, numbered to 125 — 118–125 are the YOUTUBE
...
| Test something | [`sweeps.md`](sweeps.md) — 125 rows in priority order, each with what to expect (+ the detailed phase 1–8a scripts) |
