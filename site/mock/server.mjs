...
const SETTING_SPECS = [
  ...
  ["frontdoor_shadow_channel_id", 'channel', null, null, "where this feature's rehearsals land while it is in shadow (the front door's copy); blank means shadow_channel_id. Set it to send only this feature's rehearsals somewhere else"],
  ...
  ["modmail_shadow_channel_id", 'channel', null, null, "where this feature's rehearsals land while it is in shadow (the Open a ticket button); blank means shadow_channel_id. Set it to send only this feature's rehearsals somewhere else"],
  ["minutes_shadow_channel_id", 'channel', null, null, "where this feature's rehearsals land while it is in shadow (meeting notes); blank means shadow_channel_id. Set it to send only this feature's rehearsals somewhere else"],
