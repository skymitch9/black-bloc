...
export const LABELS = {
  ...
  marathon_match_hosts: 'Whether hosts and commentators count as ours',
  ...
  marathon_board_line_template: 'One line of the board per run of ours',
  marathon_board_empty_line: 'The board’s line while nobody of ours is found',
  marathon_reminder_template: 'What a reminder before a run of ours says',
  marathon_live_template: 'What the shoutout says when a run of ours goes live',
  ...
  marathon_run_event_title_template: 'What an event made for one run of ours is called',
  marathon_run_event_description_template: 'What an event made for one run of ours says',
  marathon_run_events_reviewed: 'Whether a run of ours goes through the events review',
