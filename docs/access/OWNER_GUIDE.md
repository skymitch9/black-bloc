...
> Last verified: **2026-09-03** for the sweeps count only (**108** rows, numbered to 108 —
> 104–108 are the MEMORY PANEL build's, and 103 the operator token's; the count read 95 here
...
| Test something | [`sweeps.md`](sweeps.md) — 108 rows in priority order, each with what to expect (+ the detailed phase 1–8a scripts) |
