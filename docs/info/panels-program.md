...
| Events | `community/events.py` | `/event` (logs, create, list, cancel, settings), `/timezone` (set, show) | 7 | 2 | member (timezone) + staff | `/event`: upcoming list → pick → card (Cancel); Create modal; Timezone for me; Settings; Logs |
