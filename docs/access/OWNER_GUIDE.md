...
> Last verified: **2026-09-03** for the sweeps count (**143** rows, numbered to 143 — 135–143 are the
...
| Test something | [`sweeps.md`](sweeps.md) — 143 rows in priority order, each with what to expect (+ the detailed phase 1–8a scripts) |
