...
> Last verified: **2026-09-05** for the sweeps count (**199** rows, numbered to 199 — 188–199 are the
...
| Test something | [`sweeps.md`](sweeps.md) — 199 rows in priority order, each with what to expect (+ the detailed phase 1–8a scripts) |
