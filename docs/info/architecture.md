...
>
> | What | v116 (`main`, 2026-09-17) | Where it is measured |
> |---|---|---|
...
> | Mock contract | **19 pages / 175 routes / 14 core settings** (17/150 at v108; was 149 routes at v92) | `node site/mock/check.mjs` — figure read off the v108 gate line in `../deploys.log`, not re-run 2026-09-11 |
> | Tests | **5986** | the v116 deploy gate |
> | Deploys | **113**, last `29c77b6` (v116) at 2026-09-17 00:28 | `../deploys.log` |
>
