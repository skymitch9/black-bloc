...
> Last verified: **2026-09-04** for the sweeps count (**162** rows, numbered to 162 — 155–162 are the
...
| Test something | [`sweeps.md`](sweeps.md) — 162 rows in priority order, each with what to expect (+ the detailed phase 1–8a scripts) |
