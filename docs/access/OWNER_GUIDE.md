...
> Last verified: **2026-09-04** for the sweeps count (**182** rows, numbered to 182 — 173–182 are the
...
| Test something | [`sweeps.md`](sweeps.md) — 182 rows in priority order, each with what to expect (+ the detailed phase 1–8a scripts) |
