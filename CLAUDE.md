...
- Owner rule: on a Fable session, builds go to `model: 'opus'` subagents; Fable plans,
  ...
  (38 items traced to real findings here — 36 added 2026-09-17 by the errors build, 37 by the reconcile-lock build 2026-09-18, 38 by the spotlight-dates build 2026-09-22) and the phase's `docs/info/phaseN-design.md`.
