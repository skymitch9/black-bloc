...
> Last verified: **2026-09-04** for the sweeps count (**172** rows, numbered to 172 — 163–172 are the
...
| Test something | [`sweeps.md`](sweeps.md) — 172 rows in priority order, each with what to expect (+ the detailed phase 1–8a scripts) |
