...
> Last verified: **2026-09-03** for the sweeps count only (**116** rows, numbered to 137 —
> 130–137 are the YOUTUBE PANEL build's and 109–129 are reserved for a sibling wave-2 branch,
> so the numbering has a hole in it; 104–108 are the MEMORY PANEL build's, and 103 the operator
> token's; counted against [`sweeps.md`](sweeps.md) itself).
...
| Test something | [`sweeps.md`](sweeps.md) — 116 rows in priority order, each with what to expect (+ the detailed phase 1–8a scripts) |
