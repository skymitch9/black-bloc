...
> **Audience:** the build agent and reviewers. **Status:** TRACKED · ✅ **LIVE as v151**, plus a
> 🔨 **FOLLOW-UP BUILT on branch `channel-optout` 2026-09-21** off `main` `1a35d75` — *opting a
> channel out while it is LIVE now ends the announcement that is already out*, which this body's
> Deviation 5 got wrong. Read [**§ Follow-up 2026-09-21**](#follow-up-2026-09-21-opting-out-ends-the-announcement-that-is-already-out)
> before trusting Deviation 5. ⚠️ **The follow-up is not merged, not deployed, and has not met
> Discord.** Was: 🔨 **BUILT on branch `channel-streamers` 2026-09-21** (design: Fable, 08:2x, dispatched to Opus the
