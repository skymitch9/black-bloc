...
| **602** (was `EF-g`) | On the dashboard's **Events** page, open the event from row 595 | Its detail card reads **Review post** (not *Review channel*) and its button reads **Remove its post**. The link opens the post |
