...
> | Mock contract | **20 pages / 186 routes / 24 core settings** on branch `boot-status` — re-RUN 2026-09-17 in that worktree, not read off a gate line (21 core settings at v132; 17 pages / 150 routes at v108; was 149 routes at v92) | `node site/mock/check.mjs` |
