...
const SETTING_SPECS = [
  ...
  ["golive_autolink_youtube_video", "bool", false, false, "whether a Discord status carrying a YouTube VIDEO address is read to find whose channel the video is on. off by default, because the page it has to read can change and the video playing is not always the streamer's own; on links the person to the channel behind the video"],
