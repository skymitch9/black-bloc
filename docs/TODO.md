...
- **Wave-1 review findings — what is still open after ENGINEERING SWEEP 3 (v93, 2026-09-05; the
  ...
  **Q2 create-recurrence web route — DEFERRED 2026-09-06 10:23** (owner said "Next question" without
  answering; recommendation (b) Discord-only stands, nothing built either way); **Q3 Logs button
  `count`/`important_only` — ASKED 10:23**, recommendation (b) `Show more` + `Important only` buttons
  on the list, waiting on owner; there is no
