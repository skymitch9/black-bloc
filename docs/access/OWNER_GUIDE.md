...
> Last verified: **2026-09-04** for the sweeps count (**154** rows, numbered to 154 — 144–154 are the
...
| Test something | [`sweeps.md`](sweeps.md) — 154 rows in priority order, each with what to expect (+ the detailed phase 1–8a scripts) |
