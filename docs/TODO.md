...
- **Wave-1 review findings — what is still open after ENGINEERING SWEEP 3 (v93, 2026-09-05; the
  ...
  **Q2 create-recurrence web route — DECIDED 2026-09-06 11:00, owner verbatim "2. A"** (dashboard
  form; design [`info/recurrence-web-create-design.md`](info/recurrence-web-create-design.md), **BUILD
  DISPATCHED 11:10**, Opus, branch `recur-web`, worktree `C:/lcw/bb-recur-web`, est 150–220k); **Q3 Logs
  button `count`/`important_only` — DECIDED 11:00, owner verbatim "3. B"** (buttons on the list; design
  [`info/logs-buttons-design.md`](info/logs-buttons-design.md), **BUILD DISPATCHED 11:10**, Opus, branch
  `logs-buttons`, worktree `C:/lcw/bb-logs-buttons`, est 120–180k); the old wording follows — there is no
