...
| Applications | `community/applications.py` | `/apply` | 0 | 1 | member + staff | ✅ **BUILT** (`worktree-agent-abf063b9177e02f17`, wave 1) — `/apply` opens the panel; BOTH groups and all seventeen subcommands are retired, so this is the program's second real `commands synced` drop (43 → 42). [`applications-panel-design.md`](applications-panel-design.md) |
