...
> Last verified: **2026-09-03** for the POLLS row (`/poll` is one command that opens a panel — live in v65 14:14; not run by eye), the EVENTS row (`/event` is one command that opens a panel and
...
| Test something | [`sweeps.md`](sweeps.md) — 86 rows in priority order, each with what to expect (+ the detailed phase 1–8a scripts) |
